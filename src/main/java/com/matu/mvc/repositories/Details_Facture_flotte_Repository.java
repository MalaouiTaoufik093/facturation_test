...
@CrossOrigin("*")
public interface Details_Facture_flotte_Repository extends JpaRepository<Details_facture_flotte, Integer> {

	@Query(nativeQuery = true, value = "exec [dbo].[ps_MatuFac_EditerFactureDetailFlotte] :numefacture")
	List<Details_facture_flotte> details_facture_flotte(@Param("numefacture") String numefacture);

	/*
	 * @Query(nativeQuery = true, value =
	 * "exec [ps_MatuFac_EditerFactureDetail] :numefacture") List<Details_facture>
	 * details_facture_flotte(@Param ("numefacture") String numefacture);
	 * 
	 * @Query(nativeQuery = true, value =
	 * "select exercice from Matu_otofactureMono where NumFacture = :numefacture")
	 * String get_exercice(@Param ("numefacture") String numefacture);
	 */
	/*
	 * @Query(nativeQuery = true, value =
