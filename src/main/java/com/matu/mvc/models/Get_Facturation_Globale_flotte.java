...
@Entity
public class Get_Facturation_Globale_flotte {
	@Id
	...
	public Get_Facturation_Globale_flotte() {
		super();
	}

	public Get_Facturation_Globale_flotte(Integer idquittance, String client, String police, String date_effet, String date_au,
