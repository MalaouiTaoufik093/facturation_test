...
@Entity
public class Details_facture_flotte {
	@Id
...
//	private String numfacture;
	...
	private Double rap;
	public Details_facture_flotte() {
		super();
	}

	

	public Details_facture_flotte(String police, String matricule, String client,double pht,double taxe,double pttc) {
		super();
		this.police = police;
