...
@Entity
public class Get_Facturation_Details {
	@Id
	...
	private double taxe;
	private double pttc;
	public Get_Facturation_Details() {
		super();
	}
	...
	public Get_Facturation_Details(Integer idquittance, String client, String police, String date_effet, String date_au,
